...
const testAPI = async () => {
  try {
    ...
    // Test 1: Get topics
    console.log("Testing: GET /placement/companies/TCS/topics?type=coding");
    ...
    console.log("Testing: GET /placement/companies/TCS/questions?type=coding&topic=Recursion&difficulty=easy");
