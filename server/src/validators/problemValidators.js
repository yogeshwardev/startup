...
export const createProblemValidator = [
  ...
  body("visibleTestCases").isArray({ min: 1 }).withMessage("visibleTestCases must contain at least one case."),
  body("hiddenTestCases").isArray({ min: 1 }).withMessage("hiddenTestCases must contain at least one case."),
